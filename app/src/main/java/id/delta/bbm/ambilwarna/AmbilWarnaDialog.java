...
public class AmbilWarnaDialog {
    ...
    public static int setviewHue() {
        return Alaska.ctx.getResources().getIdentifier("ambilwarna_viewHue", "id", Alaska.ctx.getPackageName());
    }


    public static int setviewSatVal() {
        return Alaska.ctx.getResources().getIdentifier("ambilwarna_viewSatBri", "id", Alaska.ctx.getPackageName());
    }


    public static int setviewCursor() {
        return Alaska.ctx.getResources().getIdentifier("ambilwarna_cursor", "id", Alaska.ctx.getPackageName());
    }


    public static int setviewOldColor() {
        return Alaska.ctx.getResources().getIdentifier("ambilwarna_oldColor", "id", Alaska.ctx.getPackageName());
    }

    public static int setviewNewColor() {
        return Alaska.ctx.getResources().getIdentifier("ambilwarna_newColor", "id", Alaska.ctx.getPackageName());
    }

    public static int setviewTarget() {
        return Alaska.ctx.getResources().getIdentifier("ambilwarna_target", "id", Alaska.ctx.getPackageName());
    }

    public static int setviewContainer() {
        return Alaska.ctx.getResources().getIdentifier("ambilwarna_viewContainer", "id", Alaska.ctx.getPackageName());
    }

    public static int setviewAlphaOverlay() {
        return Alaska.ctx.getResources().getIdentifier("ambilwarna_overlay", "id", Alaska.ctx.getPackageName());
    }

    public static int setviewAlphaCursor() {
        return Alaska.ctx.getResources().getIdentifier("ambilwarna_alphaCursor", "id", Alaska.ctx.getPackageName());
    }

    public static int setviewAlphaCheckered() {
        return Alaska.ctx.getResources().getIdentifier("ambilwarna_alphaCheckered", "id", Alaska.ctx.getPackageName());
    }

    public static int setviewInput() {
        return Alaska.ctx.getResources().getIdentifier("input_warna", "id", Alaska.ctx.getPackageName());
    }

    public static int setlayoutDialog() {
        return Alaska.ctx.getResources().getIdentifier("delta_ambilwarna_dialog", "layout", Alaska.ctx.getPackageName());
    }
    ...
    public AmbilWarnaDialog(final Context context, int color, boolean supportsAlpha, OnAmbilWarnaListener listener) {
        ...
        final View view = LayoutInflater.from(context).inflate(PreferenceUtils.getID("delta_ambilwarna_dialog","layout"), null);
        viewHue = view.findViewById(PreferenceUtils.getID("ambilwarna_viewHue","id"));
        viewSatVal = (AmbilWarnaSquare) view.findViewById(PreferenceUtils.getID("ambilwarna_viewSatBri","id"));
        viewCursor = (ImageView) view.findViewById(PreferenceUtils.getID("ambilwarna_cursor","id"));
        viewOldColor = view.findViewById(PreferenceUtils.getID("ambilwarna_oldColor","id"));
        viewNewColor = view.findViewById(PreferenceUtils.getID("ambilwarna_newColor","id"));
        viewTarget = (ImageView) view.findViewById(PreferenceUtils.getID("ambilwarna_target","id"));
        viewContainer = (ViewGroup) view.findViewById(PreferenceUtils.getID("ambilwarna_viewContainer","id"));
        viewAlphaOverlay = view.findViewById(PreferenceUtils.getID("ambilwarna_overlay","id"));
        viewAlphaCursor = (ImageView) view.findViewById(PreferenceUtils.getID("ambilwarna_alphaCursor","id"));
        viewAlphaCheckered = (ImageView) view.findViewById(PreferenceUtils.getID("ambilwarna_alphaCheckered","id"));
        viewInput = (EditText)view.findViewById(PreferenceUtils.getID("input_warna","id"));
        ...
        TextWatcher textWatcher = new TextWatcher() {
            ...
            private void updateColor() {
                if (isValidColor(viewInput.getText().toString()) == true){
                    ...
                    viewNewColor.setBackgroundColor(colour);
                ...
                .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if (AmbilWarnaDialog.this.listener != null) {
                            ...
                            AmbilWarnaDialog.this.listener.onOk(AmbilWarnaDialog.this, getColor2());
                        }
                    }
                })
